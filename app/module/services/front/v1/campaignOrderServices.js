      ...
      .populate([
        {
          path : "seller_user_id",
          model : "kw_users",
          select : "users_type users_name users_mobile bind_person_name bind_user_type store_name pos_device_id area" 
        },
        {
          path : "ticket",
...
exports.createDate = async function (options) {
  try {
    return await orderModel.create(options)
  } catch (error) {
    return Promise.reject(error);
  }
}//End of Function

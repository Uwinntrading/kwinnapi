...
const Services         = require("../../../../../../services/admin/v1/cms/GeneralInfoServices");
...
exports.add = async function (req, res) {
    ...
    try { 
        const { 
            ...
            ios_version  , choose_coupon , draw_time_start , draw_time_end , app_url , delivery_charge , drawdata_pin , comming_soon_pro_btn , 
            comming_soon_text , home_botttom_slider_header , prize_title , enable_u_points_in_pos ,website ,markup_commission, analyser_start_time, analyser_end_time,
            lotto_coupon_selection
        } = req.body;
        let logo; 
        ...
        const options = {
            ...
            whatsapp_authorization_key : whatsapp_authorization_key,
            app_url                 : app_url,
            draw_time_end           : draw_time_end,
            draw_time_start         : draw_time_start,
            delivery_charge         : delivery_charge,
            drawdata_pin            : drawdata_pin,
            comming_soon_pro_btn    : comming_soon_pro_btn,
            comming_soon_text       : comming_soon_text,
            home_botttom_slider_header : home_botttom_slider_header,
            prize_title             : prize_title,
            website                 : website,
            markup_commission       : markup_commission,
            enable_u_points_in_pos  : enable_u_points_in_pos,
            ...(analyser_start_time && {analyser_start_time : analyser_start_time}),
            ...(analyser_end_time && {analyser_end_time : analyser_end_time}),
            lotto_coupon_selection : lotto_coupon_selection || 'Y',
            status                  : "A",
...
exports.update = async function (req, res) {
    try {  
        ...
        const {  
            alt_text, email_id, contact_no, address, facebook_link, linkedin_link, twitter_link, 
            insta_link, you_tube, slider_type, whatsapp_no, whatsapp_authorization_key , android_version , 
            ios_version , draw_time_start , draw_time_end , app_url , delivery_charge , drawdata_pin , comming_soon_pro_btn , website, markup_commission,
            comming_soon_text , home_botttom_slider_header , prize_title ,choose_coupon, enable_u_points_in_pos , id ,status, analyser_start_time, analyser_end_time,
            lotto_coupon_selection
        } = req.body;
         ...
         const options = {
             ...
             data : {
                ...
                ...(markup_commission ? { markup_commission: markup_commission } : ''),

...
const Services = require("../../../../../../services/admin/v1/cms/CampaignAccessPermissionService");
...
exports.add = async function (req, res) {
    ...
    try {
        const { seleted_campaign, seleted_users , allowd_user_id } = req.body;
        const counter = await counterService.getSequence('kw_allowed_campaigns_permission');
        const options = {
            section_id       : counter.seq,
            seleted_campaign : seleted_campaign,
            seleted_users    : seleted_users,
            status: "A",
...
exports.update = async function (req, res) {
    try {
        ...
        const { seleted_campaign, seleted_users , id, status } = req.body;
        ...
        const options = {
            ...
            data: {
                ...(seleted_campaign ? { seleted_campaign: seleted_campaign } : ''),
                ...(seleted_users    ? { seleted_users: seleted_users } : ''),

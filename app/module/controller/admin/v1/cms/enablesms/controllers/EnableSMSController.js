...
const Services = require("../../../../../../services/admin/v1/cms/EnableSMSCMSServices");
...
exports.add = async function (req, res) {
    ...
    try {
        const { smscountry,sms_country_available_country,digitizebird,digitizebird_available_country } = req.body;
        const counter = await counterService.getSequence('kw_paymentmode');
        const options = {
            section_id  : counter.seq,
            smscountry    : smscountry,
            digitizebird  : digitizebird,
            sms_country_available_country : sms_country_available_country,
            digitizebird_available_country : digitizebird_available_country,
            status      : "A",
...
exports.update = async function (req, res) {
    try {
        ...
        const {  id, status, smscountry,sms_country_available_country,digitizebird,digitizebird_available_country } = req.body;
        ...
        const options = {
            ...
            data: {
                ...(smscountry ? { smscountry: smscountry } : ''),
                ...(sms_country_available_country ? { sms_country_available_country: sms_country_available_country } : ''),
                ...(digitizebird ? { digitizebird: digitizebird } : ''),
                ...(digitizebird_available_country ? { digitizebird_available_country: digitizebird_available_country } : ''),
